<template>
  <v-navigation-drawer dark color="#363740" app>
    ...
    <v-list dense nav>
      <v-list-item id="goToListPost" link @click="$router.push('/listPost')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToListComment" link @click="$router.push('/listComment')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToListMessage" link @click="$router.push('/listMessage')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToListUser" link @click="$router.push('/listUser')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToListProduct" link @click="$router.push('/listProduct')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToListBill" link @click="$router.push('/listBill')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToStatSales" link @click="$router.push('/statSales')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToStatGamification" link @click="$router.push('/statGamification')">
        <v-list-item-icon>
      ...
      <v-list-item id="goToSettings" link @click="$router.push('/settings')">
        <v-list-item-icon>
